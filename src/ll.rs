...
pub const GNUNET_SCHEDULER_REASON_SHUTDOWN: ::libc::c_uint = 1;
pub const GNUNET_SCHEDULER_REASON_TIMEOUT: ::libc::c_uint = 2;
pub const GNUNET_SCHEDULER_REASON_READ_READY: ::libc::c_uint = 4;
pub const GNUNET_SCHEDULER_REASON_WRITE_READY: ::libc::c_uint = 8;
pub const GNUNET_SCHEDULER_REASON_PREREQ_DONE: ::libc::c_uint = 16;
...
pub const GNUNET_CONTAINER_SLIST_DISPOSITION_STATIC: ::libc::c_uint = 2;
pub const GNUNET_CONTAINER_SLIST_DISPOSITION_DYNAMIC: ::libc::c_uint = 4;
